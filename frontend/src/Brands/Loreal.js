  ...
  return (
    <>
      <div>
        ...
        <div className="loreal-slider-container">
          <div className="loreal-slider">
            <img
              src="https://images-static.nykaa.com/uploads/bf1b89f7-dcce-4832-9c06-e99474377be9.jpg?tr=cm-pad_resize,w-1800"
              alt="Loreal Image 1"
              className="loreal-slide-image"
            />
            <img
              src="https://images-static.nykaa.com/uploads/05aa3761-d3d2-47d3-af8b-d82302f39ac8.jpg?tr=cm-pad_resize,w-1800"
              alt="Loreal Image 2"
              className="loreal-slide-image"
            />
          </div>
        ...
        <div>
          <h1 style={{ textAlign: 'center', margin: '20px 0' }}>Loreal Products</h1>
            ...
            {products.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <button
                      onClick={() => handleAddToCart('userId', 'lorealProduct', product._id, 1, product.imagePath,product.price)}
