  ...
  return (
    <>
      <div>
        ...
        <div className="huda-slider-container">
          <div className="huda-slider">
            <img
              src="https://images-static.nykaa.com/uploads/6ccb127e-c3a7-4d57-92e7-b07c7d239f69.jpg?tr=cm-pad_resize,w-1800"
              alt="Huda Image 1"
              className="huda-slide-image"
            />
            <img
              src="https://images-static.nykaa.com/uploads/c1a5c07f-e28f-4e28-80de-1328247ee78b.jpg?tr=cm-pad_resize,w-1800"
              alt="Huda Image 2"
              className="huda-slide-image"
            />
          </div>
        ...
        <div>
          <h1 style={{ textAlign: 'center', margin: '20px 0' }}>Huda Products</h1>
            ...
            {products.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    onClick={() => handleAddToCart('userId', 'hudaProduct', product._id, 1, product.imagePath,product.price)}
