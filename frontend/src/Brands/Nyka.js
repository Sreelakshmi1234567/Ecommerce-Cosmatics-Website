  ...
  return (
    <>
      <div>
        ...
        <div className="nyka-slider-container">
          <div className="nyka-slider">
            <img
              src="https://images-static.nykaa.com/uploads/9df6c566-0e14-4662-aa3f-b7379251781b.jpg?tr=cm-pad_resize,w-1800"
              alt="Nykaa Image 1"
              className="nyka-slide-image"
            />
            <img
              src="https://bangalore.mallsmarket.com/sites/default/files/photos/deals/nykaa-pink-friday-sale-29nov-2dec2019-1.JPG"
              alt="Nykaa Image 2"
              className="nyka-slide-image"
            />
          </div>
           ...
           <div class="product-card-container">
            {products.map((product) => {
              ...
              return (
                ...
                <div key={product._id} className="nyka-product-card">
                  <img
                  ...
                  <h3 >{product.name}</h3>
                    ...
                    <p  className="price-original">MRP ₹{product.mrp}</p>
