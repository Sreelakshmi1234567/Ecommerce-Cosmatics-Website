...
function Maybelline() {
  ...
  return (
    <>
      <div>
        <div className="maybelline-navbar">
          <Navbar />
        </div>
        ...
        <div className="maybelline-slider-container">
          <div className="maybelline-slider">
            <img
              src="https://images-static.nykaa.com/uploads/3d16d0ba-f67a-4c94-bbce-4a676d373265.jpg?tr=cm-pad_resize,w-1800"
              alt="Maybelline Image 1"
              className="maybelline-slide-image"
            />
            <img
              src="https://images-static.nykaa.com/uploads/0d70eca6-be1d-4d34-afc4-e57e85dbff4f.jpg?tr=cm-pad_resize,w-1800"
              alt="Maybelline Image 2"
              className="maybelline-slide-image"
            />
          </div>
        </div>
          ...
          <div class="product-card-container">
            {products.map((product) => {
              ...
              return (
                <div
                  key={product._id}
                 className="maybelline-product-card"
                >
                  <img
