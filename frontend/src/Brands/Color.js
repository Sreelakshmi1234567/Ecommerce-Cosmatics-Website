      ...
      <div>
        ...
        <div className="color-slider-container">
          <div className="color-slider">
            <img
              src="https://images-static.nykaa.com/uploads/f71fc41e-6496-4ebd-aec0-eac78e218317.jpg?tr=cm-pad_resize,w-1800"
              alt="Color Image 1"
              className="color-slide-image"
            />
            <img
              src="https://images-static.nykaa.com/uploads/5eba5494-1247-4168-9bb2-07bc8212c089.jpg?tr=cm-pad_resize,w-1800"
              alt="Color Image 2"
              className="color-slide-image"
            />
          </div>
        ...
        <div>
          <h1 style={{ textAlign: 'center', margin: '20px 0' }}>Color Products</h1>
            ...
            {products.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    onClick={() => handleAddToCart('userId', 'colorProduct', product._id, 1, product.imagePath,product.price)}
